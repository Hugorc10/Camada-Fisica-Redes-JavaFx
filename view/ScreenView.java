...
//    private CheckBox characterStufingChk;
//    private CheckBox bitStufingChk;
//    private CheckBox violacaoChk;
    ...
    private HBox addHBoxTop() {
        ...
        inputTxt.setFont(Font.font("Verdana", FontWeight.MEDIUM, 16));
        inputTxt.setPrefHeight(47);
        inputTxt.setPrefColumnCount(21);
        inputTxt.setPromptText("Type the text");

        Label bitsLbl = new Label("Bits");
        bitsLbl.setFont(Font.font("Verdana", FontWeight.EXTRA_BOLD, 20));
        bitsLbl.setTextFill(Color.BLACK);
        bitsLbl.setTranslateX(20);
        bitsLbl.setTranslateY(10);

        bitsTArea = new TextArea();
        bitsTArea.setTranslateX(20);
        bitsTArea.setPrefColumnCount(29);
        bitsTArea.setPrefRowCount(0);
        bitsTArea.setFont(Font.font("Arial", FontWeight.MEDIUM, 16));
        ...
        hBox.getChildren().addAll(startBtn, stopBtn, clearBtn, inputTxt, bitsLbl, bitsTArea);
...
//
//        framingChk = new CheckBox("Contagem de caracteres");
//        characterStufingChk = new CheckBox("Insercao de bytes");
//        bitStufingChk = new CheckBox("Insercao de bits");
//        violacaoChk = new CheckBox("Violação");
...
//        });
        ...
        Image image = new Image(ScreenView.class.getResourceAsStream("/img/computer-networks-a-tanenbaum-5th-editionee-1-638.jpg"));

        ImageView networkImage = new ImageView();
        networkImage.setFitHeight(300);
...
//        vBox2.getChildren().addAll(title2, framingChk, characterStufingChk, bitStufingChk, violacaoChk);
    ...
    public void addStackPane(HBox hb) {
        ...
        Rectangle helpIcon = new Rectangle(75, 50);
    ...
    public Pane addPaneCenter() {
        ...
        speedSld.setMajorTickUnit(250);
        speedSld.setMinorTickCount(5);
        ...
        for (int i = 0; i < binaryLine1.length; i++) {
            ...
            pane.getChildren().addAll(binaryLine1[i]);
        }
    ...
    public HBox addHBoxBottom() {
        ...
        receiverTxt.setFont(Font.font("Verdana", FontWeight.MEDIUM, 20));
        receiverTxt.setPrefHeight(45);
        receiverTxt.setPrefColumnCount(21);

        hBox.getChildren().addAll(receiverLbl, receiverTxt);
